...
y_test = dataset_test.iloc[:, [1,4]].values #Dataframe de 1 columna
y_test = sc.fit_transform(y_test)
y_test = y_test[:,0]
#Predecir las acciones de diciembre 19 febrero 20
...
history = regressor.fit(X_train, y_train, validation_data = (X_test, y_test), epochs = 300, batch_size = 32, callbacks = [es, mc])
...
#Cargamos los datos del mes de enero-marzo de 2020
dataset_test = pd.read_csv("C:/Users/Daniel/Desktop/TFM/Datos/BTC_test_feb2020.csv")
real_price = dataset_test.iloc[:, [1]].values #Dataframe de 1 columna
y_test = dataset_test.iloc[:, [1]].values #Esto tengo que cambiarlo
