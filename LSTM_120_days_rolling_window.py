...
period = 120 #tamaño de la "rolling window"
...
forecast_errors_120 = [real_price[j]-predicted_price[j] for j in range(len(real_price))]
print(forecast_errors_120)

df_120 = pd.DataFrame(forecast_errors_120)
df_120.to_csv('C:/Users/Daniel/Desktop/TFM/error_120.csv', index=False, header = ["Data"])
