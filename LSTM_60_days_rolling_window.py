...
period = 60 #tamaño de la "rolling window"
...
forecast_errors_60 = [real_price[j]-predicted_price[j] for j in range(len(real_price))]
print(forecast_errors_60)

df_60 = pd.DataFrame(forecast_errors_60)
df_60.to_csv('C:/Users/Daniel/Desktop/TFM/error_60.csv', index=False, header = ["Data"])
