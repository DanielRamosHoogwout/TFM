...
period = 90 #tamaño de la "rolling window"
...
forecast_errors_90 = [real_price[j]-predicted_price[j] for j in range(len(real_price))]
print(forecast_errors_90)

df_90 = pd.DataFrame(forecast_errors_90)
df_90.to_csv('C:/Users/Daniel/Desktop/TFM/error_90.csv', index=False, header = ["Data"])
